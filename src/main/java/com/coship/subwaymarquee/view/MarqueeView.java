package com.coship.subwaymarquee.view;
...
import com.coship.subwaymarquee.R;
        ...
        switch (scrollDirection){
            case LEFT_TO_RIGHT:
                ...
                if (-currentX >= screenWidth) {
                    Log.d("vivi","currentx:"+(-currentX)+"screenWidth---"+screenWidth);
            ...
            case RIGHT_TO_LEFT:
                ...
                if (currentX >= viewWidth) {
                    Log.d("vivi","currentx:"+(currentX)+"screenWidth---"+viewWidth);
